...
import {getTotalPatientsTotal, getPatientsToday,getTotalIncomeOfSpecificClinic, getTodaysIncomeOfSpecificClinic} from '../utils/function_sets'
...
const CustomizedTables = () => {
  ...
  </TableContainer> : <Typography gutterBottom variant="h5" component="h2" style={{ color: 'grey' }}>
  Today's Income
</Typography>
  )
}
